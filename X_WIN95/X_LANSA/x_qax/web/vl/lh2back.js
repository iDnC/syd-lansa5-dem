// ----------------------------
// -- Reusable Part: LH2BACK --
// ----------------------------
LANSA.addComponent(
{
   id: "LH2BACK", 
   nm: "LH2BackgroundPanel", 
   ot: "rp", 
   tp: "Reusable Part", 
   de: "Background Panel", 
   tl: 14020000
...
function( Lansa, objectId, undefined )
{
   ...
   // -- Resources --
   // ---------------
   var resource1 = Lansa.createBitmap( "lh2img01.jpg" );
   ...
   var COM_OWNER = Lansa.registerClass( objectId,
   {
      ...
      co: function()
      {
         ...
         //
         // DEFINE_COM Class(#PRIM_IMAG) Name(#Image1) DisplayPosition(1) Height(640) Image(#LH2BackgroundImage) Left(0) Parent(#COM_OWNER) TabPosition(1) TabStop(False) Top(0) Width(828) ImageAlignment(BottomCenter) ImageSizing(Cropped)
         //
