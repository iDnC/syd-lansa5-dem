// ----------------------------
// -- Reusable Part: LH2FORE --
// ----------------------------
LANSA.addComponent(
{
   id: "LH2FORE", 
   nm: "LH2ForegroundPanel", 
   ot: "rp", 
   tp: "Reusable Part", 
   de: "Foreground Panel", 
   tl: 14020000
...
function( Lansa, objectId, undefined )
{
   ...
   var COM_OWNER = Lansa.registerClass( objectId,
   {
      ...
      co: function()
      {
         ...
         //
         // DEFINE_COM Class(#LH2Destinations) Name(#Destinations) DisplayPosition(4) Parent(#COM_OWNER) TabPosition(3) TabStop(False) Top(660) Height(50) Width(636) Style(#Style1)
         //
         var DESTINATIONS = this.createReference( "DESTINATIONS", "LH2DSTLST" );
