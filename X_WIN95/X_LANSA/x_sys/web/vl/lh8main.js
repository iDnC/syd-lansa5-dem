...
function( Lansa, objectId, undefined )
{
   ...
   var COM_OWNER = Lansa.registerClass( objectId,
   {
      ...
      co: function()
      {
         ...
         //
         // DEFINE_COM Class(#LH8BackgroundPanel) Name(#BackgroundPanel) Parent(#COM_OWNER) TabStop(False) Height(800) Width(745) DisplayPosition(2)
         //
         var BACKGROUNDPANEL = this.createReference( "BACKGROUNDPANEL", "LH8BACK" );

         //
         // DEFINE_COM Class(#LH8ForegroundPanel) Name(#ForegroundPanel) Parent(#COM_OWNER) TabStop(False) Height(800) Width(745) TabPosition(2)
         //
         var FOREGROUNDPANEL = this.createReference( "FOREGROUNDPANEL", "LH8FORE" );
