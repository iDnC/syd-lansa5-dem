...
function( Lansa, objectId, undefined )
{
   ...
   var Fields = 
   {
      XDESTID:
      {
         ...
         ln: 4,
         dc: 0,
         lb: { "ENG": "Identification", "FRA": "Identification", "JPN": " ID" }[ curLanguage ],
         h1: { "ENG": "Identification", "FRA": "Identification", "JPN": " ID" }[ curLanguage ],
         h2: " ",
         h3: " ",
         de: { "ENG": "Destination Identification", "FRA": "Identification de destination", "JPN": "行き先 ID" }[ curLanguage ],
         dv: 0,
         ia: [ "FE", "RB" ]
      },
      XDESTNAME:
      {
         ...
         ln: 50,
         dc: 0,
         lb: { "ENG": "Name", "FRA": "Nom", "JPN": "名称" }[ curLanguage ],
         h1: { "ENG": "Name", "FRA": "Nom", "JPN": "名称" }[ curLanguage ],
         h2: " ",
         h3: " ",
         de: { "ENG": "Destination Name", "FRA": "Nom de destination", "JPN": "行き先名" }[ curLanguage ],
         dv: "",
         ia: [ "FE", "LC" ]
      },
      XDESTDESC:
      {
         ...
         ln: 256,
         dc: 0,
         lb: { "ENG": "Description", "FRA": "Description", "JPN": "記述" }[ curLanguage ],
         h1: { "ENG": "Description", "FRA": "Description", "JPN": "記述" }[ curLanguage ],
         h2: " ",
         h3: " ",
         de: { "ENG": "Destination Description", "FRA": "Description de destination", "JPN": "行き先の記述" }[ curLanguage ],
         dv: "",
         ia: [ "FE", "LC" ]
      },
      XDESTIMG:
      {
         ...
         ln: 0,
         dc: 0,
         lb: { "ENG": "Image", "FRA": "Image", "JPN": "イメージ" }[ curLanguage ],
         h1: { "ENG": "Destination", "FRA": "Image", "JPN": "行き先" }[ curLanguage ],
         h2: { "ENG": "Image", "FRA": "Destination", "JPN": "イメージ" }[ curLanguage ],
         h3: " ",
         de: { "ENG": "Destination Image", "FRA": "Image de destination", "JPN": "行き先イメージ" }[ curLanguage ],
         dv: Lansa.SqlNull,
         ia: [ "ASQN", "FE", "LC" ]
      }
   };
   ...
   var COM_OWNER = Lansa.registerClass( objectId,
   {
      ...
      co: function()
      {
         ...
         // -- Create Fields --
         // -------------------
         var fld = this.addFields( "LH8DSTLST", Fields );
         ...
         //
         // DEFINE_COM Class(#PRIM_LCOL<#LH8DestinationItem>) Name(#DestinationItems)
         //
         var DESTINATIONITEMS = this.createReference( "DESTINATIONITEMS", "PRIM_LCOL" );

         //
         // DEFINE_COM Class(#PRIM_DCOL<#PRIM_TBLO.Item #LH8DestinationItem>) Name(#LayoutItems)
         //
         ...
         // ----------------------------------
         DESTINATIONITEMS.setCollects( "LH8DSTITM" );
         ...
         LAYOUTITEMS.setKeyedBy( "LH8DSTITM" );
   ...
   COM_OWNER.mthLOAD = function()
   {
      ...
      //
      // DEFINE_COM Class(#LH8SERVER.LoadDestinations) Name(#LoadDestinations)
      //
      var LOADDESTINATIONS = rtn.createDataRequest( "LOADDESTINATIONS", "LH8SERVER", "LOADDESTINATIONS" );
