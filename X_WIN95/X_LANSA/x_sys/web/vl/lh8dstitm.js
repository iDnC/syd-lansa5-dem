// ------------------------------
// -- Reusable Part: LH8DSTITM --
// ------------------------------
LANSA.addComponent(
{
   id: "LH8DSTITM", 
   nm: "LH8DestinationItem", 
   ot: "rp", 
   tp: "Reusable Part", 
   de: "Destination Item", 
   tl: 14020000
...
function( Lansa, objectId, undefined )
{
   ...
   var COM_OWNER = Lansa.registerClass( objectId,
   {
      ...
      co: function()
      {
         ...
         // -- Create Fields --
         // -------------------
         var fld = this.addFields( "LH8DSTITM", Fields );
   ...
   {
      var fld = this.FLD.LH8DSTITM, ref = this.REF, rtn = Lansa.evtRoutine( this, COM_OWNER, "#COM_OWNER.Initialize", 37 );
